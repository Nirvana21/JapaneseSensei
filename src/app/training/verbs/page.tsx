        ...
        <div className="bg-white/[0.04] rounded-2xl border border-white/[0.08] p-4 sm:p-6 mb-6 animate-fade-in-up">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              ...
              <select value={formKind} onChange={e => setFormKind(e.target.value as VerbFormKind)} className="w-full px-3 py-2 rounded-lg border border-white/[0.10] bg-white/[0.06] text-[#f5ede0]">
                {FORM_OPTIONS.map(o => (
        ...
        {current && (
          <div className="bg-white/[0.04] rounded-3xl border border-white/[0.08] p-6 animate-fade-in-up">
            <div className="text-center mb-4">
              <p className="text-sm text-[#f5ede0]/50">Verbe</p>
            ...
            <div className="flex flex-col sm:flex-row gap-3 items-stretch">
              ...
              <button onClick={shuffleVerb} className="px-4 py-3 rounded-xl bg-white/[0.06] hover:bg-white/[0.10] border border-white/[0.10] text-[#f5ede0] font-semibold">Nouveau verbe</button>
            </div>
