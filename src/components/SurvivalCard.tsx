  ...
  return (
    <div className="relative max-w-lg mx-auto px-2 sm:px-0">
        ...
        className={`
          ...
          ${
            selectedAnswer === "incorrect"
              ? "border-red-500 bg-gradient-to-br from-red-50 to-red-100 scale-105"
              : "border-orange-200/80"
          }
          ${
            !showAnswer && !disabled
              ? "hover:shadow-3xl hover:scale-[1.02] hover:border-red-300"
              : ""
          }
      ...
      >
        ...
        <div
          className="absolute top-8 right-8 w-1 h-1 bg-red-400/40 rounded-full animate-ping"
          style={{ animationDelay: "1s" }}
        />
        <div
          className="absolute bottom-6 left-8 w-1.5 h-1.5 bg-yellow-400/30 rounded-full animate-bounce"
        ...
        <div className="text-center mb-6 transform transition-all duration-500 ease-out">
          ...
          <div
            className={`${content.questionClass} transition-all duration-300 hover:scale-105`}
          >
            {content.question}
          </div>
        </div>
        ...
        {showAnswer ? (
          <div className="text-center animate-fade-in-up">
            ...
            <div
              className={`${content.answerClass} transition-all duration-300 hover:scale-110`}
            >
              {content.answer}
            </div>
        ...
        direction === "jp-to-fr" ? (
          <div className="text-center text-orange-500 animate-bounce">
            <p className="text-sm font-medium">👆 Touchez pour révéler</p>
      ...
      {showAnswer && !selectedAnswer && (
        <div
          className="flex gap-3 sm:gap-4 mt-4 sm:mt-6 px-2 sm:px-0 animate-fade-in-up"
